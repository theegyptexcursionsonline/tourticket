...
const destinationId = new mongoose.Types.ObjectId('66b000000000000000000001');
const categoryId = new mongoose.Types.ObjectId('66b000000000000000000002');
const tourId = new mongoose.Types.ObjectId('66b000000000000000000003');
const now = new Date();
...
await database.collection('tours').updateOne(
  { _id: tourId },
  {
    $set: {
      ...
      longDescription: 'Visit Cairo highlights with a fixture that never touches production data.',
