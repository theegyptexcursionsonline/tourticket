...
const formatTourForAlgolia = (tour: any) => {
  return {
    ...
    price: tour.pricingSummary?.fromPrice ?? tour.price ?? 0,
    discountPrice: tour.pricingSummary?.fromPrice ?? tour.discountPrice ?? tour.price ?? 0,
    pricingVersion: tour.pricingSummary?.version ?? 0,
