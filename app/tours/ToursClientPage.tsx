...
const TourCard = ({ tour }: { tour: TourWithDetails }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -8 }}
    >
      <Link href={`/tour/${tour.slug}`} className="group block bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden border border-slate-100">
