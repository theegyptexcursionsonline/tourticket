          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
              ...
              <form action="#" method="POST">
                ...
                <div className="mb-6">
                  ...
                  <input type="tel" name="phone-number" id="phone-number" autoComplete="tel" className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500" placeholder="+1 (555) 123-4567" />
                </div>
                <div className="mb-6">
            ...
            <div className="space-y-8">
                ...
                <div className="bg-gray-50 p-8 rounded-lg shadow-lg">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center">
                            <svg className="h-6 w-6 text-blue-800 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                            </svg>
                            <span>18-A, Industrial Area, Govindpura, Bhopal (MP)</span>
                        </div>
                        <div className="flex items-center">
                            <svg className="h-6 w-6 text-blue-800 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                            </svg>
                            <span>+91 98930 30763</span>
                        </div>
                        <div className="flex items-center">
                            <svg className="h-6 w-6 text-blue-800 mr-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="rounded-lg shadow-lg overflow-hidden">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3666.012588329649!2d77.4699380750953!3d23.24233067899732!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x397c43c8aaaaaaab%3A0x1824a5913a539a8e!2sM.K.INDUSTRIES!5e0!3m2!1sen!2sin!4v1720371661649!5m2!1sen!2sin"
                        width="100%"
                        height="350"
                        style={{ border: 0 }}
                        allowFullScreen=""
