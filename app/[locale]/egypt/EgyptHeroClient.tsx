        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/tours"
                className="inline-flex min-h-12 items-center gap-3 rounded-full bg-red-600 px-12 py-4 font-semibold text-white shadow-2xl transition-colors hover:bg-red-700 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-red-300/50"
              >
