...
const SimpleTourCard = ({ tour, onAddToCartClick }: { tour: Tour; onAddToCartClick: (tour: Tour) => void }) => {
  ...
  return (
    <Link
      href={tour.slug ? contentPath('tour', tour.slug, (tour as { urlType?: string }).urlType) : '#'}
    ...
    >
      <div className="relative h-56">
        ...
        <button
          ...
          className="absolute bottom-4 right-4 z-30 bg-white text-amber-600 p-3 rounded-full border-2 border-amber-100 transition-all duration-300 transform hover:scale-110 hover:bg-amber-600 hover:text-white hover:border-amber-600 focus:outline-none"
