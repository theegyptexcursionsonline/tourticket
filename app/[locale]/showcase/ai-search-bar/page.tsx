...
export const metadata: Metadata = {
  title: 'Search Tours | Egypt Excursions Online',
  description: 'Search and discover tours with an intelligent search bar. Get instant answers and tour recommendations.',
};
...
export default async function AISearchBarShowcasePage() {
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                Type a question or search for tours. The intelligent search bar understands
                what you need and returns personalized results with tour recommendations.
              </p>

              <div className="flex flex-wrap justify-center gap-6 mb-12">
                {['Natural Language', 'Tour Results', 'Follow-up Questions', 'Instant Answers'].map((feature) => (
          ...
          {tours.length > 0 ? (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tours.map((tour: any) => {
                ...
                return (
                  <Link key={tour._id} href={`/showcase/ai-search-bar/${tour.slug}`}
                    className="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:border-cyan-200 transition-all duration-300">
                    ...
                    <div className="p-5">
                      <h3 className="font-bold text-gray-900 mb-2 group-hover:text-cyan-600 transition-colors line-clamp-2">{tour.title}</h3>
                      ...
                      <span className="text-cyan-600 font-semibold text-sm group-hover:underline">View Details →</span>
                    </div>
                  </Link>
                );
              })}
