...
export const metadata: Metadata = {
  title: 'Inline Booking Widget Showcase | Egypt Excursions Online',
  description: 'See the inline booking widget in action. Full booking flow embedded directly on the page — no popups, no sidebars. Book tours seamlessly.',
};
...
async function getPublishedTours() {
  try {
    ...
    console.error('Failed to fetch tours for inline booking showcase:', error);
    return [];
  }
}

export default async function InlineBookingShowcasePage() {
      ...
      <main className="min-h-screen bg-gradient-to-b from-emerald-50 to-white pt-20">
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 font-serif">
                Book Directly
                <span className="text-emerald-600"> On Page</span>
              </h1>

              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                The inline booking widget embeds the full booking experience directly into the page.
                No popups, no sidebars — customers book without leaving the content they&apos;re reading.
              </p>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 pb-20">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">
            Choose a Tour to See the Inline Widget
          </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tours.map((tour: any) => {
                ...
                return (
                  <Link
                    key={tour._id}
                    href={`/showcase/inline-booking/${tour.slug}`}
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <span className="text-emerald-600 font-semibold text-sm group-hover:underline">View with Inline Booking &rarr;</span>
                    </div>
                  </Link>
                );
              })}
