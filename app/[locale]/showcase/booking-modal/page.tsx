...
export const metadata: Metadata = {
  title: 'Booking Modal Widget Showcase | Egypt Excursions Online',
  description: 'See the booking modal widget in action. A popup modal booking experience that overlays your page — clean, focused, and distraction-free.',
};
...
async function getPublishedTours() {
  try {
    ...
    console.error('Failed to fetch tours for modal showcase:', error);
    return [];
  }
}

export default async function BookingModalShowcasePage() {
      ...
      <main className="min-h-screen bg-gradient-to-b from-purple-50 to-white pt-20">
          ...
          <div className="max-w-7xl mx-auto relative">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 font-serif">
                Book in a
                <span className="text-purple-600"> Popup Modal</span>
              </h1>

              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
                The booking modal opens as a centered popup overlay. Clean, focused, and
                distraction-free — customers complete their booking without navigating away.
              </p>
        ...
        <section className="max-w-7xl mx-auto px-4 md:px-8 pb-20">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">
            Choose a Tour to See the Modal Widget
          </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {tours.map((tour: any) => {
                ...
                return (
                  <Link
                    key={tour._id}
                    href={`/showcase/booking-modal/${tour.slug}`}
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <span className="text-purple-600 font-semibold text-sm group-hover:underline">View with Modal Booking &rarr;</span>
                    </div>
                  </Link>
                );
              })}
