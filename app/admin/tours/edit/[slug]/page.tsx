...
type EditableTour = NonNullable<React.ComponentProps<typeof TourForm>['tourToEdit']>;

const EditTourPage = () => {
    const [tourData, setTourData] = useState<EditableTour | null>(null);
            ...
            fetch(`/api/admin/tours/${slug}`, { headers: getAuthHeaders() })
                ...
                .then(data => {
                    if (data.success && data.data) {
                        const tour = data.data as EditableTour;
