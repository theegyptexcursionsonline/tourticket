        ...
        <div className="max-w-3xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-2">
            {([
              ...
              // Client-requested naming swap (26 Jul): the tour collection is
              // called "Category" and the landing page is called "Catalogue".
              // Labels only — the underlying ids and behaviour are unchanged.
              ...
              return (
                <button
                  ...
                  className={`flex items-start gap-3 p-4 rounded-xl border-2 text-left transition-all ${selected ? 'border-indigo-500 bg-indigo-50 shadow-sm' : 'border-slate-200 bg-white hover:border-slate-300'}`}
                >
