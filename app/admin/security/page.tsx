        ...
        <div className="p-6">
          ...
          {enabled && recoveryPending && recoveryCodes.length === 0 && (
            <div className="space-y-5">
              ...
              <div>
                <label htmlFor="resumeSecurityCode" className="text-sm font-semibold text-slate-700">
                  Current authenticator code
                </label>
                <input
                  id="resumeSecurityCode"
                  value={code}
                  ...
                  maxLength={6}
                  placeholder="000000"
                  className="mt-2 w-full rounded-xl border border-slate-300 px-4 py-3 text-center text-lg font-bold tracking-[0.35em] outline-none focus:border-violet-500 focus:ring-4 focus:ring-violet-100"
                />
              </div>
              <button
                onClick={resumeRecoveryCodes}
                disabled={pendingAction !== null || !/^\d{6}$/.test(code)}
                className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-slate-950 px-5 py-3 text-sm font-bold text-white transition hover:bg-slate-800 disabled:opacity-50 sm:w-auto"
              >
                {pendingAction === 'resume-recovery'
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center rounded-xl px-5 py-3 text-sm font-bold text-violet-700 hover:bg-violet-50 disabled:opacity-50"
                >
