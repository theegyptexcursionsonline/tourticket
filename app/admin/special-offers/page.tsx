    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl transition-colors bg-amber-600 text-white hover:bg-amber-700"
        >
...
export default withAuth(SpecialOffersPage, { permissions: ['manageTours'] });
