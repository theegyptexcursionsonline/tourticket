...
const contentSecurityPolicy = [
  "default-src 'self'",
  `script-src 'self' 'unsafe-inline'${process.env.NODE_ENV === 'production' ? '' : " 'unsafe-eval'"} ${searchWidgetOrigin} ${voiceWidgetOrigin} ${bookingWidgetOrigin} https://www.googletagmanager.com https://maps.googleapis.com https://www.google.com https://www.gstatic.com https://apis.google.com https://accounts.google.com https://js.stripe.com https://static.cloudflareinsights.com https://s.adroll.com https://d.adroll.com https://connect.facebook.net https://static.elfsight.com https://elfsightcdn.com https://*.elfsightcdn.com https://connect.foxestechnology.com https://widget.intercom.io https://js.intercomcdn.com`,
  "script-src-attr 'none'",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' data: https://fonts.gstatic.com https://js.intercomcdn.com",
  "img-src 'self' data: blob: https:",
  "media-src 'self' blob: https:",
  `connect-src 'self' ${searchWidgetOrigin} ${bookingApiOrigin} https://tiles.openfreemap.org https://*.algolia.net https://*.algolianet.com https://*.algolia.io https://*.googleapis.com https://*.firebaseio.com wss://*.firebaseio.com https://www.google.com https://www.gstatic.com https://apis.google.com https://accounts.google.com https://www.googletagmanager.com https://www.google-analytics.com https://analytics.google.com https://region1.google-analytics.com https://*.stripe.com https://*.intercom.io wss://*.intercom.io https://*.intercomcdn.com https://connect.foxestechnology.com wss://connect.foxestechnology.com https://*.sentry.io https://*.ingest.sentry.io https://*.ingest.us.sentry.io https://*.ingest.de.sentry.io https://static.cloudflareinsights.com https://*.elfsight.com https://*.elfsightcdn.com https://*.adroll.com https://connect.facebook.net https://www.facebook.com https://api.exchangerate-api.com https://api.fixer.io https://res.cloudinary.com`,
