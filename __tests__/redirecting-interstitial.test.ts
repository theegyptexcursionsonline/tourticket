...
describe('checkout interstitial', () => {
  ...
  it('keeps the redirect target relative — an open redirect at the payment step', () => {
    expect(read(PAGE)).toContain("safeRelativeRedirect(searchParams.get('to'), '/checkout')");
  });
