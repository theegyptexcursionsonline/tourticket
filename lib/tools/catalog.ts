...
export const OFFICIAL_TOOLS = [
  ...
  {
    id: 'photo-planner',
    name: 'Egypt Golden Hour Photo Planner',
    category: 'Photography',
    description: 'Exact sunrise, sunset and golden-hour times for Egypt’s great sites, with shooting guidance.',
    embedPath: '/embed/photo-planner.html',
    icon: 'camera',
  },
  {
    id: 'marine-life-calendar',
    name: 'Red Sea Marine Life Calendar',
    category: 'Diving',
    description: 'Month-by-month likelihood of dugongs, dolphins, whale sharks and more, by Red Sea area.',
    embedPath: '/embed/marine-life.html',
    icon: 'fish',
  },
  {
    id: 'customs-checker',
    name: 'Can I Bring It? Egypt Customs Checker',
    category: 'Entry',
    description: 'Advisory verdicts for drones, medication, cash, vapes and camera gear, with the official confirmation route.',
    embedPath: '/embed/customs-checker.html',
    icon: 'shield',
  },
  {
    id: 'crowd-calendar',
    name: 'Egypt Attraction Crowd Calendar',
    category: 'Timing',
    description: 'Month and time-of-day crowd levels for the marquee sites, with the quietest window named.',
    embedPath: '/embed/crowd-calendar.html',
    icon: 'crowd',
  },
  {
