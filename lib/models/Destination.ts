...
const DestinationTranslationSchema = new Schema(
  {
    ...
    thingsToDo: [{ type: String, trim: true, maxlength: 300 }],
    localCustoms: [{ type: String, trim: true, maxlength: 500 }],
    metaTitle: { type: String, trim: true, maxlength: 60 },
    metaDescription: { type: String, trim: true, maxlength: 160 },
    weatherWarnings: [{ type: String, trim: true, maxlength: 300 }],
    averageTemperature: {
      summer: { type: String, trim: true, maxlength: 100 },
      winter: { type: String, trim: true, maxlength: 100 },
    },
...
country: {
  ...
  translations: {
    type: Map,
    of: DestinationTranslationSchema,
  },
