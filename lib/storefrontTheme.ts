...
export function resolveStorefrontTheme(
  ...
  return isStorefrontTheme(savedTheme)
    ? savedTheme
    : systemPrefersDark
      ? 'dark'
      : 'light';
...
// Runs before paint so returning visitors do not see the light storefront flash
// before their saved or operating-system preference is applied.
