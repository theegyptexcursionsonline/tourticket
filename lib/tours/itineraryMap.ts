...
export function itineraryEmbedMapUrl(stop: string, apiKey?: string | null): string {
...
export function itineraryStaticMapUrl(stops: string[], apiKey?: string | null): string | null {
