export const PRACTICAL_DEFAULTS = {
  ...
  physicalRequirements: 'Moderate walking may be required. Please review the itinerary and tell us about mobility concerns before booking.',
  transportationDetails: 'Meeting point and transfer instructions will be provided with the booking confirmation.',
  mealInfo: 'Meals are not included unless the tour inclusions say otherwise. Please share dietary requirements before travel.',
  weatherPolicy: 'The tour normally operates in suitable conditions. If severe weather makes the experience unsafe, we will offer a reschedule or refund.',
  photoPolicy: 'Photography is welcome unless a venue or guide identifies a local restriction. Please respect other guests privacy.',
  tipPolicy: 'Gratuities are not included and remain optional.',
  seasonalVariations: 'Timings and the order of activities may change seasonally while preserving the booked experience.',
} as const;
