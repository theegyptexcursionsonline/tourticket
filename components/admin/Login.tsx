              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    inputMode="text"
                    maxLength={64}
                    className="w-full rounded-xl border border-slate-300 py-3 pl-10 pr-3 text-base font-semibold tracking-wider text-slate-900 outline-none transition focus:border-red-500 focus:ring-4 focus:ring-red-100"
                    placeholder="000000"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    required
                    autoComplete="email"
                    className="w-full rounded-xl border border-slate-300 py-3 pl-10 pr-3 text-slate-900 outline-none transition focus:border-red-500 focus:ring-4 focus:ring-red-100"
