        ...
        <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-auto">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex flex-col">
              <span className="text-xs text-slate-500 font-medium leading-tight">{t('available')}</span>
              <span className="text-sm sm:text-base font-bold text-slate-900 leading-tight">
                {interest.products} {interest.products === 1 ? t('tourSingular') : t('tourPlural')}
              </span>
            </div>
          </div>
          ...
          <div className={`w-10 h-10 bg-gradient-to-br ${gradient} rounded-xl flex items-center justify-center transition-all duration-300 shadow-md group-hover:shadow-lg group-hover:scale-110`}>
            <ArrowIcon className="w-5 h-5 text-white transition-transform duration-300" strokeWidth={2.5} />
          </div>
        </div>
      </div>
              ...
              <div className="text-[10px] md:text-xs text-gray-500 flex items-center gap-1.5 md:gap-2.5 flex-wrap">
                ...
                {hit.tourCount && (
                  <span className="bg-emerald-50/80 backdrop-blur-sm px-1.5 md:px-2.5 py-0.5 md:py-1 rounded-md md:rounded-lg font-medium text-emerald-700">
                    {hit.tourCount} {hit.tourCount === 1 ? t('tourSingular') : t('tourPlural')}
                  </span>
                )}
              </div>
            </div>
      ...
      <section className="relative bg-gradient-to-b from-white via-slate-50 to-white py-8 sm:py-12 md:py-16 lg:py-20">
        <div className="container mx-auto px-3 sm:px-4 max-w-[1400px] relative z-10">
          <div className="text-center py-12 sm:py-16">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-slate-900 mb-2">{t('noResultsTitle')}</h3>
            <p className="text-slate-600 text-sm">{t('noResultsSubtitle')}</p>
          </div>
        </div>
      </section>
    );
      ...
      <div className="container mx-auto px-3 sm:px-4 max-w-[1400px] relative z-10">
        <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-red-100 to-orange-100 rounded-full mb-3 sm:mb-4 border border-red-200">
            ...
            <span className="text-xs sm:text-sm font-bold text-red-700">{t('badge')}</span>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="relative group">
              ...
              <div className="relative flex items-center">
                ...
                <input
                  type="text"
                  placeholder={chatMode ? t('aiPlaceholder') : t('searchPlaceholder')}
                  value={searchTerm}
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {chatMode ? (
                        ...
                        <>
                          ...
                          <span className="text-xs font-bold text-gray-700 uppercase tracking-wider">
                            {searchTerm ? t('searchResultsLabel') : t('popularSearchesLabel')}
                          </span>
                        </>
                      )}
                    </div>
                  ...
                  {chatMode ? (
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(Array.isArray(t.raw('popularSearches')) ? (t.raw('popularSearches') as string[]) : []).map((term) => (
                          <button
                            key={term}
                            onClick={() => {
                              setSearchTerm(term);
