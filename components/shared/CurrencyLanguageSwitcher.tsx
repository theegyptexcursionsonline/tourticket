            ...
            <div className="p-6 border-b bg-white">
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 rtl:pl-4 rtl:pr-10 pr-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                />
              </div>
            </div>
                  ...
                  {filteredItems.map(item => {
                    return (
                      <button 
                        ...
                        className={`p-4 rounded-lg text-left rtl:text-right transition-all duration-200 hover:scale-105 ${
  ...
  return (
    <>
      ...
      <SettingsModal
        ...
        onSelectItem={(item) => handleLanguageSelect(item as Language)}
