  ...
  return (
    <section className="bg-slate-50 py-12" data-testid="linked-page-listings">
      <div className="container mx-auto px-6">
        <h2 className="mb-2 text-3xl font-bold text-slate-900">{title.trim() || 'Explore more'}</h2>
        {subtitle.trim() ? <p className="mb-8 text-slate-600">{subtitle}</p> : <div className="mb-8" />}
