...
const CalendarPopup: FC<{
  ...
  return (
    <>
      ...
      <div 
        ref={calendarRef} 
        className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-white rounded-lg shadow-2xl border w-[90vw] max-w-[600px] max-h-[90vh] overflow-hidden"
      >
...
const BookingSidebar: FC<BookingSidebarProps> = ({ isOpen, onClose, tour }) => {
  ...
  const handleAddToCart = () => {
    ...
    // Create a cart item that matches the Tour type expected by addToCart
    const cartItem = {
      ...tour,
      quantity: guests,
              ...
              <div className="p-6 border-t bg-white flex-shrink-0">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <button 
                    ...
                    className="w-full bg-slate-800 text-white font-bold py-3 rounded-full hover:bg-slate-900 transition-colors"
                  >
                    ADD TO CART
                  </button>
                  <button className="w-full bg-red-500 text-white font-bold py-3 rounded-full hover:bg-red-600 transition-colors">
                    BOOK NOW
                  </button>
                </div>
                <p className="text-xs text-slate-500 mt-4 text-center">
                  <b>Having doubts?</b> You can cancel or reschedule this booking up to 8 hours in advance for free.
                </p>
              </div>
            </motion.div>
          </motion.div>
