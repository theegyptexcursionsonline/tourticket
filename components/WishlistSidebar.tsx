      ...
      {isWishlistSidebarOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 rtl:right-auto rtl:left-0 h-full w-full max-w-md bg-white shadow-2xl z-50 flex flex-col"
            role="dialog"
            aria-modal="true"
          ...
          >
            ...
            {wishlist.length === 0 ? (
              <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
                ...
                <h3 className="font-bold text-lg text-slate-700">Your wishlist is empty</h3>
                <p className="text-slate-500 mt-2">Add your favorite tours to your wishlist to see them here.</p>
                <Link
                  href="/search"
                  onClick={closeWishlistSidebar}
