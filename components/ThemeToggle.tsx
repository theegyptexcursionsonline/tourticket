...
export default function ThemeToggle({
  ...
  const locale = !mounted || typeof document === 'undefined'
    ? 'en'
  ...
  return (
    <button
      ...
      title={label}
      onClick={toggleTheme}
      className={`inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current focus-visible:ring-offset-2 ${
        transparent
