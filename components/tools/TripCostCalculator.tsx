...
// Interactive Egypt trip-cost calculator. Renders from the central tools-API
// config (styles/visa passed in from the server component) and computes locally
// so the controls react instantly.
...
export default function TripCostCalculator({
  ...
  const r = useMemo(() => computeTripCost(config, { days, travelers, style }), [config, days, travelers, style]);
