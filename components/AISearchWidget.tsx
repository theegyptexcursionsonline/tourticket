...
function TourHits({ onHitClick, limit = 5 }: { onHitClick?: () => void; limit?: number }) {
  ...
  return (
    <div>
      <div className="px-6 py-3.5 bg-gradient-to-r from-blue-500/5 via-indigo-500/5 to-purple-500/5 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
            <MapPin className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
          </div>
          <span className="text-xs font-semibold text-gray-700 tracking-wide">
            Tours
          </span>
          <span className="ml-auto text-xs font-medium text-gray-400 bg-gray-100/80 backdrop-blur-sm px-2.5 py-1 rounded-full">
            {hits.length}
          </span>
        </div>
      </div>
      {limitedHits.map((hit: any, index) => (
        <motion.a
          ...
          className="block px-6 py-4 hover:bg-gradient-to-r hover:from-blue-500/5 hover:via-indigo-500/5 hover:to-transparent transition-all duration-300 border-b border-white/5 last:border-0 group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            {/* Tour Image */}
            <div className="w-20 h-20 rounded-2xl flex-shrink-0 overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-100 shadow-sm group-hover:shadow-xl group-hover:scale-105 transition-all duration-300 ring-1 ring-black/5">
            ...
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-gray-900 text-[15px] leading-snug mb-1.5 truncate group-hover:text-blue-600 transition-colors duration-300">
                {hit.title || 'Untitled Tour'}
              </div>
              <div className="text-xs text-gray-500 flex items-center gap-2.5 flex-wrap">
                {hit.location && (
                  <span className="flex items-center gap-1.5 bg-gray-50/80 backdrop-blur-sm px-2.5 py-1 rounded-lg">
                    <MapPin className="w-3 h-3 text-gray-400" strokeWidth={2.5} />
                ...
                {(hit.price || hit.discountPrice) && (
                  <span className="flex items-center gap-1 bg-gradient-to-r from-blue-50 to-indigo-50 px-2.5 py-1 rounded-lg font-bold text-blue-600 text-xs">
...
function DestinationHits({ onHitClick, limit = 5 }: { onHitClick?: () => void; limit?: number }) {
  ...
  return (
    <div>
      <div className="px-6 py-3.5 bg-gradient-to-r from-emerald-500/5 via-teal-500/5 to-cyan-500/5 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-500/25">
      ...
      {limitedHits.map((hit: any, index) => (
        <motion.a
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: index * 0.05, duration: 0.3 }}
          className="block px-6 py-4 hover:bg-gradient-to-r hover:from-emerald-500/5 hover:via-teal-500/5 hover:to-transparent transition-all duration-300 border-b border-white/5 last:border-0 group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-100 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-xl group-hover:scale-105 transition-all duration-300 ring-1 ring-black/5">
              <Compass className="w-7 h-7 text-emerald-600" strokeWidth={2.5} />
            </div>
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-gray-900 text-[15px] leading-snug mb-1.5 truncate group-hover:text-emerald-600 transition-colors duration-300">
                {hit.name || 'Untitled Destination'}
              </div>
              <div className="text-xs text-gray-500 flex items-center gap-2.5 flex-wrap">
                {hit.country && (
                  <span className="bg-gray-50/80 backdrop-blur-sm px-2.5 py-1 rounded-lg font-medium">{hit.country}</span>
                )}
                {hit.tourCount && (
                  <span className="bg-emerald-50/80 backdrop-blur-sm px-2.5 py-1 rounded-lg font-medium text-emerald-700">
                    {hit.tourCount} tours
                  </span>
                )}
              </div>
...
function CategoryHits({ onHitClick, limit = 5 }: { onHitClick?: () => void; limit?: number }) {
  ...
  return (
    <div>
      <div className="px-6 py-3.5 bg-gradient-to-r from-purple-500/5 via-fuchsia-500/5 to-pink-500/5 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-purple-500 to-fuchsia-600 flex items-center justify-center shadow-lg shadow-purple-500/25">
            <Tag className="w-3.5 h-3.5 text-white" strokeWidth={2.5} />
          </div>
          <span className="text-xs font-semibold text-gray-700 tracking-wide">
            Categories
          </span>
      ...
      {limitedHits.map((hit: any, index) => (
        <motion.a
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: index * 0.05, duration: 0.3 }}
          className="block px-6 py-4 hover:bg-gradient-to-r hover:from-purple-500/5 hover:via-fuchsia-500/5 hover:to-transparent transition-all duration-300 border-b border-white/5 last:border-0 group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-50 to-fuchsia-100 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-xl group-hover:scale-105 transition-all duration-300 ring-1 ring-black/5">
              <Tag className="w-7 h-7 text-purple-600" strokeWidth={2.5} />
            </div>
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-gray-900 text-[15px] leading-snug mb-1.5 truncate group-hover:text-purple-600 transition-colors duration-300">
                {hit.name || 'Untitled Category'}
              </div>
              <div className="text-xs text-gray-500 flex items-center gap-2.5">
                {hit.tourCount && (
                  <span className="bg-purple-50/80 backdrop-blur-sm px-2.5 py-1 rounded-lg font-medium text-purple-700">
                    {hit.tourCount} tours
                  </span>
                )}
              </div>
...
function BlogHits({ onHitClick, limit = 5 }: { onHitClick?: () => void; limit?: number }) {
  ...
  return (
    <div>
      <div className="px-6 py-3.5 bg-gradient-to-r from-amber-500/5 via-orange-500/5 to-red-500/5 backdrop-blur-xl border-b border-white/10">
        <div className="flex items-center gap-2.5">
          <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg shadow-amber-500/25">
      ...
      {limitedHits.map((hit: any, index) => (
        <motion.a
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: index * 0.05, duration: 0.3 }}
          className="block px-6 py-4 hover:bg-gradient-to-r hover:from-amber-500/5 hover:via-orange-500/5 hover:to-transparent transition-all duration-300 border-b border-white/5 last:border-0 group relative overflow-hidden"
        >
          ...
          <div className="flex items-center gap-4 relative z-10">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center flex-shrink-0 shadow-sm group-hover:shadow-xl group-hover:scale-105 transition-all duration-300 ring-1 ring-black/5">
              <FileText className="w-7 h-7 text-amber-600" strokeWidth={2.5} />
            </div>
            <div className="flex-1 min-w-0">
              <div className="font-semibold text-gray-900 text-[15px] leading-snug mb-1.5 truncate group-hover:text-amber-600 transition-colors duration-300">
                {hit.title || 'Untitled Blog Post'}
              </div>
              <div className="text-xs text-gray-500 flex items-center gap-2.5 flex-wrap">
                {hit.category && (
                  <span className="bg-gray-50/80 backdrop-blur-sm px-2.5 py-1 rounded-lg font-medium">{hit.category}</span>
                )}
                {hit.readTime && (
                  <span className="bg-amber-50/80 backdrop-blur-sm px-2.5 py-1 rounded-lg font-medium text-amber-700">
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="hidden md:flex fixed bottom-8 left-0 right-0 z-30 justify-center px-6 pointer-events-none"
      >
        <div className="w-full max-w-3xl pointer-events-auto">
          <div className="ai-search-container relative">
              ...
              {isExpanded && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-full mb-4 left-0 right-0 rounded-[28px] overflow-hidden shadow-2xl"
                    style={{ 
                      maxHeight: '70vh',
                  ...
                  >
                    ...
                    <div className="flex flex-col h-full">
                      {/* Header */}
                      <div className="px-7 py-5 border-b border-white/20 backdrop-blur-xl"
                        style={{
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            >
                              <Sparkles className="w-4 h-4 text-blue-500" strokeWidth={2.5} />
                            </motion.div>
                      ...
                      {/* Trending Section */}
                      {!searchQuery && (
                        <div className="border-t border-white/20 px-7 py-5 backdrop-blur-xl"
                          style={{
                            background: 'linear-gradient(to right, rgba(99, 102, 241, 0.03), rgba(168, 85, 247, 0.03))'
                          }}
                        >
                          <div className="flex items-center gap-2.5 mb-4">
                            <div className="w-6 h-6 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
                          ...
                          <div className="flex flex-wrap gap-2.5">
                            {['Pyramids', 'Nile Cruise', 'Desert Safari', 'Luxor', 'Tours under $100'].map((trend, index) => (
                              <motion.button
                                ...
                                className="px-4 py-2.5 rounded-2xl text-xs font-semibold text-gray-700 hover:text-blue-700 transition-all duration-300 hover:scale-105 shadow-sm hover:shadow-md"
                                style={{
              ...
              >
                <div className="relative">
                  <input
                    ...
                    className="ai-search-input w-full pl-16 pr-36 py-5 text-[15px] font-medium text-gray-900 placeholder-gray-400 bg-transparent outline-none cursor-text relative z-10 rounded-full tracking-tight"
                    style={{ cursor: 'text' }}
                  />
                  ...
                  <div className="absolute left-5 top-1/2 transform -translate-y-1/2 z-10">
                    ...
                    >
                      <div 
                        className={`w-10 h-10 rounded-[14px] flex items-center justify-center transition-all duration-500 shadow-lg`}
                        style={{
                          background: isExpanded
                  ...
                  <div className="absolute right-5 top-1/2 transform -translate-y-1/2 flex items-center gap-3 z-10">
                    {isExpanded ? (
                      <motion.div
                      ...
                      >
                        <div 
                          className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-2xl shadow-sm"
                          style={{
                        ...
                        >
                          ...
                          />
                          <span className="text-[11px] font-bold text-blue-700 uppercase tracking-wide">Live</span>
                        </div>
                        <div 
                      ...
                      <motion.div
                        ...
                        className="w-10 h-10 rounded-[14px] flex items-center justify-center shadow-md"
                        style={{
            ...
            {isExpanded && (
              ...
              >
                <div 
                  className="inline-flex items-center gap-3 text-xs text-gray-600 px-5 py-3 rounded-[18px] shadow-lg"
                  style={{
