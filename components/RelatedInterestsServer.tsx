// components/RelatedInterestsServer.tsx
...
interface RelatedInterestsServerProps {
  currentSlug?: string;
  limit?: number;
  title?: string;
  subtitle?: string;
